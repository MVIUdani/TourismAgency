...
User.updateById = (id, user, result) => {
  sql.query(
    "UPDATE users SET user_name = ?, user_password = ?, first_name = ?,last_name = ?,email_address = ?, phone_no = ?,user_status = ?, registered_date = ?,last_visit_date = ?, age = ?,nic = ?, birthday = ?,hotel_name = ?, hotel_contact_no = ?,city = ?, role_id = ? WHERE user_id = ?",
    [user.user_name,
     user.user_password,
     user.first_name,
     user.last_name,
