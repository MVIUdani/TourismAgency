...
router.post("/cus-signup", validInfo, async (req, res) => {
  ...
  try {
   ...
   /* const newUser = await con.query(
    ...
    let token = null;
    con.query("INSERT INTO users (first_name,last_name,email_address, user_password,user_name,role_id) VALUES (?,?,?, ?, ?,'1') ", [firstname, lastname, email, bcryptPassword, username],
