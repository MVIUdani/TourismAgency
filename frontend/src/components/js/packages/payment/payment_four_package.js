...
export default function PaymentFirst_P4() {
  ...
  const handleChange=(e)=>{
    ...
    return (
        <div className="app-container">
          <div className="row">
            <div className="col">
              <Item name="Package 4" price="" img="logo.jpg" />
            </div>
            ...
            <form>
             ...
             <label for="full"><h5>Full Payment: Rs.204,000</h5></label>
             <br></br>
             
             <input type="radio" value="advance" id="bus" 
               onChange={handleChange} name="type" />
             <label for="advance"><h5>Advance: Rs.51,000</h5></label>
