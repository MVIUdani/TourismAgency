...
function Package_one_hotel_details(){
      ...
      <div className="Monitor">
        <div className="Hotel">
            ...
            <div className="Hotel_details">
              <div className="Day">
                <h1>Day 01 & Day 02</h1>
                <h4>Hotel Name: Sigiriya Hotel</h4><br></br>
...
<hr></hr>
        ...
        <img className="Hotel_size" src='hotel/polon_hotel.jpg' alt="" width="470" height="270"></img>
        <img className="Hotel_size" src='hotel/polon_hotel2.jpg' alt="" width="255" height="250"></img>
        <img className="Hotel_size" src='hotel/polon_food1.jpg' alt="" width="230" height="210"></img>

        <img className="Hotel_size" src='hotel/polon_food2.jpg' alt="" width="265" height="225"></img>
        <img className="Hotel_size" src='hotel/polon_ele.jpg' alt="" width="230" height="212"></img>
...
<div className="Hotel_details">
  <div className="Day">
    ...
    <br></br><br></br>
    <h5>If not available this hotel for relevent booked days. We give the other hotel: <Link to='/hotel_food_details'><h6>Hotel Foods</h6></Link></h5>
...
export default Package_one_hotel_details;