...
function Package_one_hotel_details(){
    ...
    return(
        ...
        <div className="Hotel">
            ...
            <img className="Hotel_size" src='hotel/sigiriya_hotelnew.jpg' alt="" width="475" height="240"></img>
            <img className="Hotel_size" src='hotel/sigiriya location.jpg' alt="" width="190" height="240"></img>
            <img className="Hotel_size" src='hotel/sigiriya_hotel_room.jpg' alt="" width="260" height="195"></img>
            
            <img className="Hotel_size" src='hotel/sigiriya_food.jpg' alt="" width="265" height="220"></img>
            <img className="Hotel_size" src='hotel/sifiriya_food2.jpg' alt="" width="160" height="215"></img>
