...
export default function BeforePackagedetails() {
...
<br></br>
 ...
 <br></br>  
          ...
          <Link to="#"><button className="Btn1" type="button"><h6>Request New Package</h6></button></Link>
          <Link to="#"><button className="Btn1" type="button"><h6>Book Now</h6></button></Link>
