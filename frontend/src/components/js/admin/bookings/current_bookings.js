...
function createData(id, bookingID, date, customerID,booked_date, packageID, no_of_days,  paymentID, no_of_visitors, guideID,  booking_status) {
  return { id, bookingID, date, customerID,  booked_date, packageID, no_of_days,  paymentID, no_of_visitors, guideID, booking_status };
}

const rows = [
  createData('1', '23', '12/7/21', '234', '19/7/21','7', '3', '4', '3', '34','CONFIRMED'),
  createData('1', '23', '12/7/21', '234', '19/7/21','7', '3', '4', '3',  '21','CANCELLED'),
];
